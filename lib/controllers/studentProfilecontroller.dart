...
class StudentProfileController extends GetxController {
  ...
  void FetchProfileRecord() async {
    ...
    if (user != null) {
      final TeacherSnapshot = await FirebaseFirestore.instance.collection("Student").doc(user.uid).get();
  ...
  void UpdateFullName(String newName) async {
    ...
    if (user != null) {
      ...
      FirebaseFirestore.instance.collection("Student").doc(user.uid).update({"FullName": newName});
    }
  }
  void showEditDialog() {
